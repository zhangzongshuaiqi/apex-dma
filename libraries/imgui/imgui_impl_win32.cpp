...
//  ImGuiKey_PrintScreen as Windows doesn't emit it (same behavior as GLFW/SDL). 2023-09-07: Inputs:
//  Added support for keyboard codepage conversion for when application is compiled in MBCS mode and
//  using a non-Unicode window. 2023-04-19: Added ImGui_ImplWin32_InitForOpenGL() to facilitate
//  combining raw Win32/Winapi with OpenGL. (#3218) 2023-04-04: Inputs: Added support for
...
static void ImGui_ImplWin32_AddKeyEvent(ImGuiKey key,
                                        bool down,
                                        int native_keycode,
  ...
  switch (msg) {
    ...
    case WM_SYSKEYUP: {
      ...
      if (wParam < 256) {
        ...
        // (keypad enter doesn't have its own... VK_RETURN with KF_EXTENDED flag means keypad enter,
        // see IM_VK_KEYPAD_ENTER definition for details, it is mapped to ImGuiKey_KeyPadEnter.)
        int vk = (int)wParam;

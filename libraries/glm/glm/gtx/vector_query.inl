...
struct compute_areCollinear<2, T, Q> {
  GLM_FUNC_QUALIFIER static bool call(vec<2, T, Q> const& v0,
                                      vec<2, T, Q> const& v1,
                                      T const& epsilon) {
...
struct compute_areCollinear<3, T, Q> {
  GLM_FUNC_QUALIFIER static bool call(vec<3, T, Q> const& v0,
                                      vec<3, T, Q> const& v1,
                                      T const& epsilon) {
...
struct compute_areCollinear<4, T, Q> {
  GLM_FUNC_QUALIFIER static bool call(vec<4, T, Q> const& v0,
                                      vec<4, T, Q> const& v1,
                                      T const& epsilon) {
...
struct compute_isCompNull<4, T, Q> {
  GLM_FUNC_QUALIFIER static vec<4, bool, Q> call(vec<4, T, Q> const& v, T const& epsilon) {
    return vec<4, bool, Q>((abs(v.x) < epsilon), (abs(v.y) < epsilon), (abs(v.z) < epsilon),
                           (abs(v.w) < epsilon));
  }
};
...
template <length_t L, typename T, qualifier Q>
GLM_FUNC_QUALIFIER bool areCollinear(vec<L, T, Q> const& v0,
                                     vec<L, T, Q> const& v1,
                                     T const& epsilon) {
...
template <length_t L, typename T, qualifier Q>
GLM_FUNC_QUALIFIER bool areOrthogonal(vec<L, T, Q> const& v0,
                                      vec<L, T, Q> const& v1,
                                      T const& epsilon) {
  GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559,
  ...
  return abs(dot(v0, v1)) <=
         max(static_cast<T>(1), length(v0)) * max(static_cast<T>(1), length(v1)) * epsilon;
}
...
template <length_t L, typename T, qualifier Q>
GLM_FUNC_QUALIFIER bool areOrthonormal(vec<L, T, Q> const& v0,
                                       vec<L, T, Q> const& v1,
                                       T const& epsilon) {

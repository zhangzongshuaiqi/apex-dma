...
template <length_t D, typename T, qualifier Q>
GLM_FUNC_QUALIFIER mat<D, D, T, Q> computeCovarianceMatrix(vec<D, T, Q> const* v,
                                                           size_t n,
                                                           vec<D, T, Q> const& c) {
...
template <length_t D, typename T, qualifier Q, typename I>
GLM_FUNC_QUALIFIER mat<D, D, T, Q> computeCovarianceMatrix(I const& b,
                                                           I const& e,
                                                           vec<D, T, Q> const& c) {
  glm::mat<D, D, T, Q> m(0);
  glm::vec<D, T, Q> v;
...
template <length_t D, typename T, qualifier Q>
GLM_FUNC_QUALIFIER unsigned int findEigenvaluesSymReal(mat<D, D, T, Q> const& covarMat,

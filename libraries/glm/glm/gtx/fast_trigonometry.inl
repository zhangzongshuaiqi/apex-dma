...
GLM_FUNC_QUALIFIER vec<L, T, Q> taylorCos(vec<L, T, Q> const& x) {
  return static_cast<T>(1) - (x * x) * (1.f / 2.f) + ((x * x) * (x * x)) * (1.f / 24.f) -
...
GLM_FUNC_QUALIFIER T cos_52s(T x) {
  ...
  return (T(0.9999932946) +
          xx * (T(-0.4999124376) + xx * (T(0.0414877472) + xx * T(-0.0012712095))));
}
...
GLM_FUNC_QUALIFIER T fastAsin(T x) {
  return x + (x * x * x * T(0.166666667)) + (x * x * x * x * x * T(0.075)) +
         ...
         (x * x * x * x * x * x * x * x * x *
          T(0.0303819444));  // + (x * x * x * x * x * x * x * x * x * x * x * T(0.022372159));
}

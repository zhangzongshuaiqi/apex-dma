...
GLM_FUNC_QUALIFIER vec<L, floatType, Q> compNormalize(vec<L, T, Q> const& v) {
  ...
  return detail::compute_compNormalize<L, T, floatType, Q, std::numeric_limits<T>::is_integer,
...
GLM_FUNC_QUALIFIER vec<L, T, Q> compScale(vec<L, floatType, Q> const& v) {
  ...
  return detail::compute_compScale<L, T, floatType, Q, std::numeric_limits<T>::is_integer,
                                   std::numeric_limits<T>::is_signed>::call(v);
}

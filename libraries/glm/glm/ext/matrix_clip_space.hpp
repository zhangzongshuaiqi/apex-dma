...
///
/// @see - glm::ortho(T const& left, T const& right, T const& bottom, T const& top, T const& zNear,
/// T const& zFar)
/// @see <a
...
/// GLM_FORCE_LEFT_HANDED if defined or right-handed coordinates otherwise. The near and far clip
/// planes correspond to z normalized device coordinates of -1 and +1 respectively. (OpenGL clip
/// volume definition)
///
/// @tparam T A floating-point scalar type
///
...
/// Creates a matrix for an orthographic parallel viewing volume, using left-handed coordinates.
/// If GLM_FORCE_DEPTH_ZERO_TO_ONE is defined, the near and far clip planes correspond to z
/// normalized device coordinates of 0 and +1 respectively. (Direct3D clip volume definition)
/// Otherwise, the near and far clip planes correspond to z normalized device coordinates of -1 and
...
/// Creates a matrix for an orthographic parallel viewing volume, using the default handedness and
/// default near and far clip planes definition. To change default handedness use
/// GLM_FORCE_LEFT_HANDED. To change default near and far clip planes definition use
/// GLM_FORCE_DEPTH_ZERO_TO_ONE.
///
/// @tparam T A floating-point scalar type
///
/// @see - glm::ortho(T const& left, T const& right, T const& bottom, T const& top)
/// @see <a href="https://www.khronos.org/registry/OpenGL-Refpages/gl2.1/xhtml/glOrtho.xml">glOrtho
/// man page</a>
template <typename T>
...
/// Creates a frustum matrix using left-handed coordinates if GLM_FORCE_LEFT_HANDED if defined or
/// right-handed coordinates otherwise. The near and far clip planes correspond to z normalized
/// device coordinates of 0 and +1 respectively. (Direct3D clip volume definition)
///
/// @tparam T A floating-point scalar type
template <typename T>
...
/// Creates a frustum matrix using left-handed coordinates if GLM_FORCE_LEFT_HANDED if defined or
/// right-handed coordinates otherwise. The near and far clip planes correspond to z normalized
/// device coordinates of -1 and +1 respectively. (OpenGL clip volume definition)
///
/// @tparam T A floating-point scalar type
template <typename T>
...
/// Creates a frustum matrix with default handedness, using the default handedness and default near
/// and far clip planes definition. To change default handedness use GLM_FORCE_LEFT_HANDED. To
/// change default near and far clip planes definition use GLM_FORCE_DEPTH_ZERO_TO_ONE.
///
/// @tparam T A floating-point scalar type
/// @see <a
/// href="https://www.khronos.org/registry/OpenGL-Refpages/gl2.1/xhtml/glFrustum.xml">glFrustum man
/// page</a>
template <typename T>
...
/// respectively. (Direct3D clip volume definition)
///
/// @param fovy Specifies the field of view angle, in degrees, in the y direction. Expressed in
/// radians.
...
/// Creates a matrix for a symmetric perspective-view frustum using left-handed coordinates if
/// GLM_FORCE_LEFT_HANDED if defined or right-handed coordinates otherwise. The near and far clip
/// planes correspond to z normalized device coordinates of 0 and +1 respectively. (Direct3D clip
/// volume definition)
///
/// @param fovy Specifies the field of view angle, in degrees, in the y direction. Expressed in
/// radians.
...
/// Creates a matrix for a symmetric perspective-view frustum based on the default handedness and
/// default near and far clip planes definition. To change default handedness use
/// GLM_FORCE_LEFT_HANDED. To change default near and far clip planes definition use
/// GLM_FORCE_DEPTH_ZERO_TO_ONE.
///
...
/// Builds a perspective projection matrix based on a field of view and the default handedness and
/// default near and far clip planes definition. To change default handedness use
/// GLM_FORCE_LEFT_HANDED. To change default near and far clip planes definition use
/// GLM_FORCE_DEPTH_ZERO_TO_ONE.
///

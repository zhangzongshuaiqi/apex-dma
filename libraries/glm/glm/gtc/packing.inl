...
//	{
//		return ((floatTo11bit(x) & ((1 << 11) - 1)) << 0) |  ((floatTo11bit(y) & ((1 << 11)
//- 1)) << 11) | ((floatTo10bit(z) & ((1 << 10) - 1)) << 22);
//	}
...
struct compute_half<4, Q> {
  ...
  GLM_FUNC_QUALIFIER static vec<4, float, Q> unpack(vec<4, uint16, Q> const& v) {
    i16vec4 Unpack;
    memcpy(&Unpack, &v, sizeof(Unpack));
    return vec<4, float, Q>(detail::toFloat32(Unpack.x), detail::toFloat32(Unpack.y),
...
GLM_FUNC_QUALIFIER uint64 packHalf4x16(glm::vec4 const& v) {
  i16vec4 const Unpack(detail::toFloat16(v.x), detail::toFloat16(v.y), detail::toFloat16(v.z),
...
GLM_FUNC_QUALIFIER glm::vec4 unpackHalf4x16(uint64 v) {
  i16vec4 Unpack;
  memcpy(&Unpack, &v, sizeof(Unpack));
  return vec4(detail::toFloat32(Unpack.x), detail::toFloat32(Unpack.y), detail::toFloat32(Unpack.z),
...
GLM_FUNC_QUALIFIER vec3 unpackF2x11_1x10(uint32 v) {
  return vec3(detail::packed11bitToFloat(v >> 0), detail::packed11bitToFloat(v >> 11),
...
GLM_FUNC_QUALIFIER uint32 packF3x9_E1x5(vec3 const& v) {
  ...
  float const ExpShared =
      equal(MaxShared, pow(2.0f, 9.0f), epsilon<float>()) ? ExpSharedP + 1.0f : ExpSharedP;
...
GLM_FUNC_QUALIFIER vec3 unpackF3x9_E1x5(uint32 v) {
  ...
  return vec3(Unpack.data.x, Unpack.data.y, Unpack.data.z) *
         pow(2.0f, static_cast<float>(Unpack.data.w) - 15.f - 9.f);
}

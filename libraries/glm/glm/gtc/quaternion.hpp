...
/// @see ext_quaternion_relational
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR vec<4, bool, Q> greaterThanEqual(qua<T, Q> const& x,
                                                             qua<T, Q> const& y);
...
///
/// @param direction Desired forward direction onto which the -z-axis gets mapped. Needs to be
/// normalized.
/// @param up Up vector, how the camera is oriented. Typically (0, 1, 0).
template <typename T, qualifier Q>

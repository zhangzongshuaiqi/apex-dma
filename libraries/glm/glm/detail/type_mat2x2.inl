...
mat<2, 2, T, Q>::mat(T const& x0, T const& y0, T const& x1, T const& y1)
#if GLM_HAS_INITIALIZER_LISTS
...
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
mat<2, 2, T, Q>::mat(X1 const& x1, Y1 const& y1, X2 const& x2, Y2 const& y2)
#if GLM_HAS_INITIALIZER_LISTS
...
GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<2, 2, T, Q>::mat(vec<2, V1, Q> const& v1,
                                                      vec<2, V2, Q> const& v2)
#if GLM_HAS_INITIALIZER_LISTS
...
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR typename mat<2, 2, T, Q>::col_type& mat<2, 2, T, Q>::operator[](
    typename mat<2, 2, T, Q>::length_type i) GLM_NOEXCEPT {
...
mat<2, 2, T, Q>::operator[](typename mat<2, 2, T, Q>::length_type i) const GLM_NOEXCEPT {
  GLM_ASSERT_LENGTH(i, this->length());
  return this->value[i];
}
...
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<2, 2, T, Q> operator+(mat<2, 2, T, Q> const& m1,
...
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<3, 2, T, Q> operator*(mat<2, 2, T, Q> const& m1,
...
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 2, T, Q> operator*(mat<2, 2, T, Q> const& m1,
...
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR bool operator==(mat<2, 2, T, Q> const& m1,
                                                 mat<2, 2, T, Q> const& m2) {

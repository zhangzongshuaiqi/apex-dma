...
struct compute_mix_vector {
  GLM_FUNC_QUALIFIER GLM_CONSTEXPR static vec<L, T, Q> call(vec<L, T, Q> const& x,
                                                            vec<L, T, Q> const& y,
                                                            vec<L, U, Q> const& a) {
    GLM_STATIC_ASSERT(std::numeric_limits<U>::is_iec559 || GLM_CONFIG_UNRESTRICTED_FLOAT ||
...
struct compute_mod {
  GLM_FUNC_QUALIFIER static vec<L, T, Q> call(vec<L, T, Q> const& a, vec<L, T, Q> const& b) {
    GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559 || GLM_CONFIG_UNRESTRICTED_FLOAT,
                      "'mod' only accept floating-point inputs. Include <glm/gtc/integer.hpp> for "
                      "integer inputs.");
...
GLM_FUNC_QUALIFIER GLM_CONSTEXPR genFIType sign(genFIType x) {
  GLM_STATIC_ASSERT(
      std::numeric_limits<genFIType>::is_iec559 || GLM_CONFIG_UNRESTRICTED_FLOAT ||
...
/*
   ...
   GLM_CONFIG_UNRESTRICTED_FLOAT, "'roundEven' only accept floating-point inputs");
...
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, T, Q> mix(vec<L, T, Q> const& x,
                                                  vec<L, T, Q> const& y,
                                                  U a) {

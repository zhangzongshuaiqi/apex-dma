...
struct compute_matrixCompMult_type {
  GLM_FUNC_QUALIFIER static mat<C, R, T, Q> call(mat<C, R, T, Q> const& x,
    ...
    GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559 || GLM_CONFIG_UNRESTRICTED_GENTYPE,
                      "'matrixCompMult' only accept floating-point inputs, include "
                      "<glm/ext/matrix_integer.hpp> to discard this restriction.");
...
struct compute_outerProduct {
  GLM_FUNC_QUALIFIER static typename detail::outerProduct_trait<DA, DB, T, Q>::type call(
      vec<DA, T, Q> const& c,
      vec<DB, T, Q> const& r) {
...
struct compute_outerProduct_type {
  GLM_FUNC_QUALIFIER static typename detail::outerProduct_trait<DA, DB, T, Q>::type call(
      ...
      vec<DB, T, Q> const& r) {
    GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559 || GLM_CONFIG_UNRESTRICTED_GENTYPE,
                      "'outerProduct' only accept floating-point inputs, include "
                      "<glm/ext/matrix_integer.hpp> to discard this restriction.");
...
struct compute_transpose_type {
  GLM_FUNC_QUALIFIER static mat<R, C, T, Q> call(mat<C, R, T, Q> const& m) {
    GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559 || GLM_CONFIG_UNRESTRICTED_GENTYPE,
                      "'transpose' only accept floating-point inputs, include "
                      "<glm/ext/matrix_integer.hpp> to discard this restriction.");
...
struct compute_determinant_type {
  GLM_FUNC_QUALIFIER static T call(mat<C, R, T, Q> const& m) {
    GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559 || GLM_CONFIG_UNRESTRICTED_GENTYPE,
                      "'determinant' only accept floating-point inputs, include "
                      "<glm/ext/matrix_integer.hpp> to discard this restriction.");
...
struct compute_inverse<2, 2, T, Q, Aligned> {
  GLM_FUNC_QUALIFIER static mat<2, 2, T, Q> call(mat<2, 2, T, Q> const& m) {
    ...
    mat<2, 2, T, Q> Inverse(+m[1][1] * OneOverDeterminant, -m[0][1] * OneOverDeterminant,
...
GLM_FUNC_QUALIFIER mat<C, R, T, Q> matrixCompMult(mat<C, R, T, Q> const& x,
                                                  mat<C, R, T, Q> const& y) {
  return detail::compute_matrixCompMult_type<C, R, T, Q, std::numeric_limits<T>::is_iec559,
                                             detail::is_aligned<Q>::value>::call(x, y);
}

template <length_t DA, length_t DB, typename T, qualifier Q>
GLM_FUNC_QUALIFIER typename detail::outerProduct_trait<DA, DB, T, Q>::type outerProduct(
    vec<DA, T, Q> const& c,
    vec<DB, T, Q> const& r) {
  return detail::compute_outerProduct_type<DA, DB, T, Q, std::numeric_limits<T>::is_iec559>::call(
      c, r);
}

template <length_t C, length_t R, typename T, qualifier Q>
GLM_FUNC_QUALIFIER typename mat<C, R, T, Q>::transpose_type transpose(mat<C, R, T, Q> const& m) {
  return detail::compute_transpose_type<C, R, T, Q, std::numeric_limits<T>::is_iec559,
                                        detail::is_aligned<Q>::value>::call(m);
}

template <length_t C, length_t R, typename T, qualifier Q>
GLM_FUNC_QUALIFIER T determinant(mat<C, R, T, Q> const& m) {
  return detail::compute_determinant_type<C, R, T, Q, std::numeric_limits<T>::is_iec559,
                                          detail::is_aligned<Q>::value>::call(m);
}

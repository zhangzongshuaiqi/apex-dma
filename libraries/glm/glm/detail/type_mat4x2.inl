...
mat<4, 2, T, Q>::mat(T x0, T y0, T x1, T y1, T x2, T y2, T x3, T y3)
#if GLM_HAS_INITIALIZER_LISTS
...
template <typename X0,
          ...
          typename Y3>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
mat<4, 2, T, Q>::mat(X0 x0, Y0 y0, X1 x1, Y1 y1, X2 x2, Y2 y2, X3 x3, Y3 y3)
#if GLM_HAS_INITIALIZER_LISTS
    : value{col_type(x0, y0), col_type(x1, y1), col_type(x2, y2), col_type(x3, y3)}
#endif
{
...
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR typename mat<4, 2, T, Q>::col_type& mat<4, 2, T, Q>::operator[](
    typename mat<4, 2, T, Q>::length_type i) GLM_NOEXCEPT {
...
mat<4, 2, T, Q>::operator[](typename mat<4, 2, T, Q>::length_type i) const GLM_NOEXCEPT {
  GLM_ASSERT_LENGTH(i, this->length());
  return this->value[i];
}
...
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 2, T, Q> operator+(mat<4, 2, T, Q> const& m1,
...
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR typename mat<4, 2, T, Q>::col_type operator*(
    mat<4, 2, T, Q> const& m,
...
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR typename mat<4, 2, T, Q>::row_type operator*(
...
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<2, 2, T, Q> operator*(mat<4, 2, T, Q> const& m1,
...
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<3, 2, T, Q> operator*(mat<4, 2, T, Q> const& m1,
...
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR bool operator==(mat<4, 2, T, Q> const& m1,
                                                 mat<4, 2, T, Q> const& m2) {
